...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 16, 2018 lúc 03:19 CH
...
(1, 1, 1, 1, 400000, 400000, 0),
(2, 1, 3, 1, 120000, 120000, 0),
(3, 1, 4, 1, 100000, 100000, 0);
...
(1, 'ducdeptrai', '2018-05-16 07:42:33', 620000, 'Xã Hưng Long, huyện Hưng Nguyên, Nghệ An', 3, 0);
